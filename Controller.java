...
public class Controller
{
    ...
    private void selectMenu()
    {
         ...
         while( selection == 0 && this.state == 0)
         {
            try
            {
                ...
                {
                    printMessageToView("Are you sure you want to quit? (Y:YES)");
                    key = cView.userInput();
                ...
                {
                    printMessageToView("Are you sure you want to clock out? (Y:YES)");
                    key = cView.userInput();
                    if (key.equalsIgnoreCase("Y")) {
    ...
    private void loginCheck( boolean isManager)
    {
        ...
        if( rStaff != null)//User data is found
        {
            ...
            else    //ID is found but type(Manager or Employee) is Wrong
            {
    ...
    {
        //cView.loginView();
        printMessageToView("Are you sure you want to log out? (YES:y)");
    ...
    private void addNewStaff()
    {
        ...
        while(!done)
        {
            ...
            printMessageToView("Is the staff a manager?(Y/N)");
            key = cView.userInput();
            ...
            {
                case 1:
                printMessageToView("The staff will be added as a manager.");
                break;
                case 2:
                printMessageToView("The staff will be added as an employee.");
                break;
            }
    ...
    private void updateStaff()
    {
        ...
        while(inputNumber == 0)
        {
            ...
            try
            {
                ...
                {
                    inputNumber = 0;
                    printErrorMessageToView("ID not found.");
                }
            }
            catch(Exception e)
            {
                printErrorMessageToView("ID must be an integer.");
            }
        }
        //------------- Input ID check end ----------------
                    ...
                    case 3:// Forth clock out
                        ...
                        switch(state)
                        {
                            ...
                            case Staff.WORKSTATE_FINISH:
                                ...
                                break;
                           default:
                                printErrorMessageToView("Staff:" + rStaff.getFullName() + "has not clocked in today.");
                                pause(3);
                                break;
                        }
                        done = true;
